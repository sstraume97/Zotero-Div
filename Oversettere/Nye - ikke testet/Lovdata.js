...
function formatDateNo(isoDate) {
	...
	var month = MONTHS_NO[parseInt(m[2]) - 1];
		...
		"items": [
			{
				...
				"creators": [
					{
						"creatorType": "author",
						"lastName": "Justis- og beredskapsdepartementet",
						"fieldMode": 1
					}
				],
				"notes": [],
				...
				"nameOfAct": "Lov 20. mai 2005 nr. 28 om straff (straffeloven)",
				"shortTitle": "Straffeloven",
				"codeNumber": "LOV-2005-05-20-28",
				"dateEnacted": "2005-05-20",
				"abstractNote": "Kort om loven Straffeloven er en norsk lov som regulerer straff, straffereaksjoner og straffbare handlinger. Den er den sentrale loven på dette området, men det finnes også straffebestemmelser i andre lover. Straffeloven har to hoveddeler. Den første delen har generelle regler om straff. Den har regler om vilkårene for at noen skal kunne straffes, som at man er over 15 år og at man har skyld. Denne delen har også regler om straffereaksjoner, som bot, fengsel og samfunnsstraff. Den andre delen har regler om hvilke handlinger som er straffbare, som for eksempel vold, bedrageri og skadeverk. Til grunn for strafferetten ligger prinsippet om at ingen kan straffes uten lov og dom, som er bestemt i Grunnloven § 96. Straffeloven bygger på menneskerettighetene slik de kommer til uttrykk i FNs menneskerettserklæring og Den europeiske menneskerettskonvensjon (EMK). Straffeloven ble vedtatt 20. mai 2005, men trådte først i kraft 1. oktober 2015. Da erstattet den straffeloven av 1902. En årsak til at det tok så lang tid før loven trådte i kraft var at det var nødvendig med endringer i politiets datasystemer.",
